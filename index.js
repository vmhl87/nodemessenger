...
const port = parseInt((choosePort?prompt('What port?'):3000))
var a = 0
var sockets = []
var msgs = []
var users = []
var pwds = [{u:'',p:null},{u:'ADMIN',i:-1,p:'[Symbol(IncomingMessage)]: [Function: IncomingMessage],   [Symbol(ServerResponse)]: [Function: ServerResponse],   [Symbol(kCapture)]: false,   [Symbol(asyncId)]: 6'}]
var blockedUsers = []
var pmblocked = []
